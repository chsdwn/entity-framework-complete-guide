...
{
    public partial class AddManyToManyAuthorAndBook : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Book_Id1 = table.Column<int>(type: "INTEGER", nullable: true),
                    Author_Id1 = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
