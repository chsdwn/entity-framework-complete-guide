...
namespace EFCompleteGuide.DataAccess.Migrations
{
    ...
    [Migration("20201007102157_AddFluentAuthorsFluentBooksFluentPublishersTables")]
    partial class AddFluentAuthorsFluentBooksFluentPublishersTables
    {
            ...
            modelBuilder.Entity("EFCompleteGuide.Model.Models.Book", b =>
                {
                    ...
                    b.Property<int?>("FluentPublisherPublisher_Id")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("FluentPublisherPublisher_Id");
            ...
            modelBuilder.Entity("EFCompleteGuide.Model.Models.Book", b =>
                {
                    ...
                    b.HasOne("EFCompleteGuide.Model.Models.FluentPublisher", null)
                        .WithMany("Books")
                        .HasForeignKey("FluentPublisherPublisher_Id");
            ...
            modelBuilder.Entity("EFCompleteGuide.Model.Models.BookAuthor", b =>
                {
                    ...
                    b.HasOne("EFCompleteGuide.Model.Models.FluentAuthor", null)
                        .WithMany("BookAuthors")
                        .HasForeignKey("FluentAuthorAuthor_Id");

                    b.HasOne("EFCompleteGuide.Model.Models.FluentBook", null)
                        .WithMany("BookAuthors")
