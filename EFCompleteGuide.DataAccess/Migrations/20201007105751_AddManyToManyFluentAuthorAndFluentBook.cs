...
{
    public partial class AddManyToManyFluentAuthorAndFluentBook : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FluentBook_Id = table.Column<int>(type: "INTEGER", nullable: false),
                    FluentAuthor_Id = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
